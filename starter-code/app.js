...
student.scope = () => console.log(this);
...
// There is no 'this' because joe.scope is an object and not a function
//
// 2. What is "this" when joe.scopeArrow() is invoked?
// There is no 'this' because joe.scope is an object and not a function
//
// 3. Explain why "this" is different when an arrow function is used.
// when an arrow function is used, the scope of 'this' is the either global or the scope of whatever the arrow function is nested in. But in a classic function or constructor function, the scope of 'this' is localized to the code within the function.
